...
description: Guide a user from role and work understanding to automation-ready mission backlog. Use when the user wants to describe their job, map responsibilities, break work down top-down, classify tasks by AI automation type, identify ontology seeds, choose a first low-risk automation mission, or create work-map.md, ontology-seeds.md, mission-backlog.md, automation-brief.md, or missions/*.md.
---

# Work Mission Discovery

Run a model-neutral interview that turns a user's real work into automation-ready missions. Keep the focus on common AI CLI concepts: role, outcome, workflow, task, input, output, evidence, risk, and verification.
